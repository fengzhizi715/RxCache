...
```groovy
implementation 'com.safframework.rxcache:rxcache-core:1.1.3'
```

rxcache-proxy

```groovy
implementation 'com.safframework.rxcache:rxcache-proxy:1.1.3'
```

rxcache-guava-cache

```groovy
implementation 'com.safframework.rxcache:rxcache-guava-cache:1.1.3'
```

rxcache-caffeine

```groovy
implementation 'com.safframework.rxcache:rxcache-caffeine:1.1.3'
```

rxcache-fastjson

```groovy
implementation 'com.safframework.rxcache:rxcache-fastjson:1.1.3'
```
