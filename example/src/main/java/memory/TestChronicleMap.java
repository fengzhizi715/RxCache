...
import com.safframework.rxcache.memory.ChronicleMapImpl;
import domain.User;
...
/**
 * @FileName: memory.TestChronicleMap
 * @author: Tony Shen
 * @date: 2021/11/2 2:12 下午
...
public class TestChronicleMap {
    ...
    public static void main(String[] args) {
        ...
        RxCache.config(new RxCache.Builder().memory(new ChronicleMapImpl(1024)));
